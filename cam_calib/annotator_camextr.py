# Author: Xi Luo
# Function: Annotate the camera extrinsic parameter by clicking the ground corners
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_file', default="h2tc_dataset/002870/processed/rgbd0/left_0000.jpg",
                        help='path of the image file to be annotated')
    parser.add_argument('--save_folder', default="",
                        help='folder path of the calculated parameters to be saved')
